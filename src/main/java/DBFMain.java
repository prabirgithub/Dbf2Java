...
public class DBFMain {
	...
	public static void method5(String[] args) throws Exception {	
		...
		org.flametech.dbf2java.reader.DBFResultSet reader = new org.flametech.dbf2java.reader.DBFResultSet(dbfFile);
		DBFMetadata meta = reader.getMetadata();
		System.out.println(meta);
		org.flametech.dbf2java.core.DBFRow rec = null;
		List<org.flametech.dbf2java.core.DBFRow> recs = new ArrayList<org.flametech.dbf2java.core.DBFRow>(10);
		...
		meta1.setRecordsCount(maps.size());
		//meta1.setRecordsQty(1);
		FileOutputStream out = new FileOutputStream("2.dbf"); 
		org.flametech.dbf2java.writer.DbfWriter writer = new org.flametech.dbf2java.writer.DbfWriter(meta1,out);
		writer.setStringCharset("Cp866");
//		for (com.dc.dbf2java.core.DbfRecord r : recs) {
//			writer.write(rec);
//		}
...
//		System.out.println(meta);
	...
	static void testReadWriteReadFile(File file)  throws Exception  {
		...
		DBFile dbfFile = new DBFile("E:\\Prabir\\Projects\\dpl_docs\\M_ITEM.dbf");
        dbfFile.setCharset("Cp866");
		DBFResultSet reader = new DBFResultSet(dbfFile);
		DBFMetadata meta = reader.getMetadata();
		DBFRow rec = null;
		List<Map<String,Object>> maps = new ArrayList<Map<String,Object>>();
		while ((rec = reader.nextRow()) != null) {
		...
		// 3. Read written file and compare data with initially read data
		{
			//DBFile dbfFile = new DBFile("E:\\Prabir\\Projects\\dpl_docs\\M_ITEM.dbf");
	        dbfFile.setCharset("Cp866");
			DBFResultSet reader1 = new DBFResultSet(dbfFile);
			DBFRow rec1 = null;
			List<Map<String,Object>> maps2 = new ArrayList<Map<String,Object>>();
			while ((rec1 = reader1.nextRow()) != null) {
			...
			for (Map<String,Object> map : maps2) {
				boolean mapEqual = Dbf2JavaUtils.compareMaps(map, maps.get(i));
